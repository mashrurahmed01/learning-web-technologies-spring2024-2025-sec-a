...
<body>
    ...
    <main class="main-content">
        ...
        <div class="income-container">
            ...
            <div id="addIncome">
                <form id="incomeForm" class="input-group">
                    <input type="text" id="source" name="source" placeholder="Income Source" required />
                    <input type="number" id="income" name="income" placeholder="Amount" required />
